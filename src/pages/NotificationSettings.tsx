  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <p className="text-sm text-muted">
        Choose how GymBoard reaches you. We bias toward fewer, higher-signal
        messages—never marketing blasts.
      </p>
      <Card>
        <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted">
              You can enable both—SMS is always optional.
            </p>
          </div>
            ...
            <Button
              ...
              onClick={() =>
                toast.push({
                  ...
                  description:
                    "Check your inbox for a GymBoard sample notification.",
                })
              }
            >
              Send test email
            ...
            <Button
              ...
              onClick={() =>
                toast.push({
                  ...
                  description:
                    "Mock state: add a phone number in profile to enable SMS previews.",
                })
              }
            >
              Send test SMS
      ...
      <Card>
        <CardHeader>
          ...
          <p className="mt-1 text-xs text-muted">
            The moments members care about most.
          </p>
        </CardHeader>
        <CardBody className="space-y-3">
          <Toggle
